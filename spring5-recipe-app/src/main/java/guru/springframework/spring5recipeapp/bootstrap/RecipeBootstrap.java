...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    private List<Recipe> getRecipes(){
        ...
        guacRecipe.getIngredients().add(new Ingredient("Kosher Sals", new BigDecimal(.5), teaSpoonUom));
        ...
        guacRecipe.getIngredients().add(new Ingredient("serrano chiles, stem and seeds removed, minced", new BigDecimal(2), eachUom, guacRecipe));
        ...
        guacRecipe.getIngredients().add(new Ingredient("ripe tomato, seeds and pulp removed, chipped", new BigDecimal(.5), eachUom, guacRecipe));
