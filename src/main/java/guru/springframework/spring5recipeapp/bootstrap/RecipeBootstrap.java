...
public class RecipeBootstrap implements ApplicationListener<ContextRefreshedEvent> {
    ...
    public void onApplicationEvent(ContextRefreshedEvent contextRefreshedEvent) {
        ...
        log.debug("Loading default recipe  data");
    }
    ...
    private List<Recipe> getRecipes(){
        ...
        //get UOM's
        Optional<UnitOfMeasure> eachUomOptional = unitOfMeasureRepository.findByUom("ea");
       ...
       /* guacNotes.setRecipe(guacRecipe);*/
        ...
        //very redundant could use a helper method.
        guacRecipe.addIngredient(new Ingredient("ripe avacados", new BigDecimal(2), eachUom));
        guacRecipe.addIngredient(new Ingredient("Kosher Sals", new BigDecimal(.5), teaSpoonUom));
        guacRecipe.addIngredient(new Ingredient("fresh lime juice or lemon juice", new BigDecimal(2), tableSpoonUom));
        guacRecipe.addIngredient(new Ingredient("minced onion", new BigDecimal(2), tableSpoonUom));
        guacRecipe.addIngredient(new Ingredient("serrano chiles, stem and seeds removed, minced", new BigDecimal(2), eachUom));
        guacRecipe.addIngredient(new Ingredient("Cilantro", new BigDecimal(2), tableSpoonUom));
        guacRecipe.addIngredient(new Ingredient("Freshly grated black pepper", new BigDecimal(2), dashUom));
        guacRecipe.addIngredient(new Ingredient("ripe tomato, seeds and pulp removed, chipped", new BigDecimal(.5), eachUom));
        ...
        //needed for bi-directional relationship - should be one method call.
